...
module pcihellocore_mm_interconnect_0 (
		...
		output wire [1:0]  gLed_s1_address,                          //                            gLed_s1.address
		output wire        gLed_s1_write,                            //                                   .write
		input  wire [31:0] gLed_s1_readdata,                         //                                   .readdata
		output wire [31:0] gLed_s1_writedata,                        //                                   .writedata
		output wire        gLed_s1_chipselect,                       //                                   .chipselect
		...
		output wire [1:0]  rLed_s1_address,                          //                            rLed_s1.address
		output wire        rLed_s1_write,                            //                                   .write
		input  wire [31:0] rLed_s1_readdata,                         //                                   .readdata
		output wire [31:0] rLed_s1_writedata,                        //                                   .writedata
		output wire        rLed_s1_chipselect                        //                                   .chipselect
	);
	...
	wire   [31:0] rled_s1_agent_m0_readdata;                                              // rLed_s1_translator:uav_readdata -> rLed_s1_agent:m0_readdata
	wire          rled_s1_agent_m0_waitrequest;                                           // rLed_s1_translator:uav_waitrequest -> rLed_s1_agent:m0_waitrequest
	wire          rled_s1_agent_m0_debugaccess;                                           // rLed_s1_agent:m0_debugaccess -> rLed_s1_translator:uav_debugaccess
	wire   [31:0] rled_s1_agent_m0_address;                                               // rLed_s1_agent:m0_address -> rLed_s1_translator:uav_address
	wire    [3:0] rled_s1_agent_m0_byteenable;                                            // rLed_s1_agent:m0_byteenable -> rLed_s1_translator:uav_byteenable
	wire          rled_s1_agent_m0_read;                                                  // rLed_s1_agent:m0_read -> rLed_s1_translator:uav_read
	wire          rled_s1_agent_m0_readdatavalid;                                         // rLed_s1_translator:uav_readdatavalid -> rLed_s1_agent:m0_readdatavalid
	wire          rled_s1_agent_m0_lock;                                                  // rLed_s1_agent:m0_lock -> rLed_s1_translator:uav_lock
	wire   [31:0] rled_s1_agent_m0_writedata;                                             // rLed_s1_agent:m0_writedata -> rLed_s1_translator:uav_writedata
	wire          rled_s1_agent_m0_write;                                                 // rLed_s1_agent:m0_write -> rLed_s1_translator:uav_write
	wire    [2:0] rled_s1_agent_m0_burstcount;                                            // rLed_s1_agent:m0_burstcount -> rLed_s1_translator:uav_burstcount
	wire          rled_s1_agent_rf_source_valid;                                          // rLed_s1_agent:rf_source_valid -> rLed_s1_agent_rsp_fifo:in_valid
	wire  [113:0] rled_s1_agent_rf_source_data;                                           // rLed_s1_agent:rf_source_data -> rLed_s1_agent_rsp_fifo:in_data
	wire          rled_s1_agent_rf_source_ready;                                          // rLed_s1_agent_rsp_fifo:in_ready -> rLed_s1_agent:rf_source_ready
	wire          rled_s1_agent_rf_source_startofpacket;                                  // rLed_s1_agent:rf_source_startofpacket -> rLed_s1_agent_rsp_fifo:in_startofpacket
	wire          rled_s1_agent_rf_source_endofpacket;                                    // rLed_s1_agent:rf_source_endofpacket -> rLed_s1_agent_rsp_fifo:in_endofpacket
	wire          rled_s1_agent_rsp_fifo_out_valid;                                       // rLed_s1_agent_rsp_fifo:out_valid -> rLed_s1_agent:rf_sink_valid
	wire  [113:0] rled_s1_agent_rsp_fifo_out_data;                                        // rLed_s1_agent_rsp_fifo:out_data -> rLed_s1_agent:rf_sink_data
	wire          rled_s1_agent_rsp_fifo_out_ready;                                       // rLed_s1_agent:rf_sink_ready -> rLed_s1_agent_rsp_fifo:out_ready
	wire          rled_s1_agent_rsp_fifo_out_startofpacket;                               // rLed_s1_agent_rsp_fifo:out_startofpacket -> rLed_s1_agent:rf_sink_startofpacket
	wire          rled_s1_agent_rsp_fifo_out_endofpacket;                                 // rLed_s1_agent_rsp_fifo:out_endofpacket -> rLed_s1_agent:rf_sink_endofpacket
	wire   [31:0] gled_s1_agent_m0_readdata;                                              // gLed_s1_translator:uav_readdata -> gLed_s1_agent:m0_readdata
	wire          gled_s1_agent_m0_waitrequest;                                           // gLed_s1_translator:uav_waitrequest -> gLed_s1_agent:m0_waitrequest
	wire          gled_s1_agent_m0_debugaccess;                                           // gLed_s1_agent:m0_debugaccess -> gLed_s1_translator:uav_debugaccess
	wire   [31:0] gled_s1_agent_m0_address;                                               // gLed_s1_agent:m0_address -> gLed_s1_translator:uav_address
	wire    [3:0] gled_s1_agent_m0_byteenable;                                            // gLed_s1_agent:m0_byteenable -> gLed_s1_translator:uav_byteenable
	wire          gled_s1_agent_m0_read;                                                  // gLed_s1_agent:m0_read -> gLed_s1_translator:uav_read
	wire          gled_s1_agent_m0_readdatavalid;                                         // gLed_s1_translator:uav_readdatavalid -> gLed_s1_agent:m0_readdatavalid
	wire          gled_s1_agent_m0_lock;                                                  // gLed_s1_agent:m0_lock -> gLed_s1_translator:uav_lock
	wire   [31:0] gled_s1_agent_m0_writedata;                                             // gLed_s1_agent:m0_writedata -> gLed_s1_translator:uav_writedata
	wire          gled_s1_agent_m0_write;                                                 // gLed_s1_agent:m0_write -> gLed_s1_translator:uav_write
	wire    [2:0] gled_s1_agent_m0_burstcount;                                            // gLed_s1_agent:m0_burstcount -> gLed_s1_translator:uav_burstcount
	wire          gled_s1_agent_rf_source_valid;                                          // gLed_s1_agent:rf_source_valid -> gLed_s1_agent_rsp_fifo:in_valid
	wire  [113:0] gled_s1_agent_rf_source_data;                                           // gLed_s1_agent:rf_source_data -> gLed_s1_agent_rsp_fifo:in_data
	wire          gled_s1_agent_rf_source_ready;                                          // gLed_s1_agent_rsp_fifo:in_ready -> gLed_s1_agent:rf_source_ready
	wire          gled_s1_agent_rf_source_startofpacket;                                  // gLed_s1_agent:rf_source_startofpacket -> gLed_s1_agent_rsp_fifo:in_startofpacket
	wire          gled_s1_agent_rf_source_endofpacket;                                    // gLed_s1_agent:rf_source_endofpacket -> gLed_s1_agent_rsp_fifo:in_endofpacket
	wire          gled_s1_agent_rsp_fifo_out_valid;                                       // gLed_s1_agent_rsp_fifo:out_valid -> gLed_s1_agent:rf_sink_valid
	wire  [113:0] gled_s1_agent_rsp_fifo_out_data;                                        // gLed_s1_agent_rsp_fifo:out_data -> gLed_s1_agent:rf_sink_data
	wire          gled_s1_agent_rsp_fifo_out_ready;                                       // gLed_s1_agent:rf_sink_ready -> gLed_s1_agent_rsp_fifo:out_ready
	wire          gled_s1_agent_rsp_fifo_out_startofpacket;                               // gLed_s1_agent_rsp_fifo:out_startofpacket -> gLed_s1_agent:rf_sink_startofpacket
	wire          gled_s1_agent_rsp_fifo_out_endofpacket;                                 // gLed_s1_agent_rsp_fifo:out_endofpacket -> gLed_s1_agent:rf_sink_endofpacket
	...
	wire          rled_s1_agent_rp_valid;                                                 // rLed_s1_agent:rp_valid -> router_005:sink_valid
	wire  [112:0] rled_s1_agent_rp_data;                                                  // rLed_s1_agent:rp_data -> router_005:sink_data
	wire          rled_s1_agent_rp_ready;                                                 // router_005:sink_ready -> rLed_s1_agent:rp_ready
	wire          rled_s1_agent_rp_startofpacket;                                         // rLed_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          rled_s1_agent_rp_endofpacket;                                           // rLed_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	wire          gled_s1_agent_rp_valid;                                                 // gLed_s1_agent:rp_valid -> router_006:sink_valid
	wire  [112:0] gled_s1_agent_rp_data;                                                  // gLed_s1_agent:rp_data -> router_006:sink_data
	wire          gled_s1_agent_rp_ready;                                                 // router_006:sink_ready -> gLed_s1_agent:rp_ready
	wire          gled_s1_agent_rp_startofpacket;                                         // gLed_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          gled_s1_agent_rp_endofpacket;                                           // gLed_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire          rled_s1_burst_adapter_source0_valid;                                    // rLed_s1_burst_adapter:source0_valid -> rLed_s1_agent:cp_valid
	wire  [112:0] rled_s1_burst_adapter_source0_data;                                     // rLed_s1_burst_adapter:source0_data -> rLed_s1_agent:cp_data
	wire          rled_s1_burst_adapter_source0_ready;                                    // rLed_s1_agent:cp_ready -> rLed_s1_burst_adapter:source0_ready
	wire    [7:0] rled_s1_burst_adapter_source0_channel;                                  // rLed_s1_burst_adapter:source0_channel -> rLed_s1_agent:cp_channel
	wire          rled_s1_burst_adapter_source0_startofpacket;                            // rLed_s1_burst_adapter:source0_startofpacket -> rLed_s1_agent:cp_startofpacket
	wire          rled_s1_burst_adapter_source0_endofpacket;                              // rLed_s1_burst_adapter:source0_endofpacket -> rLed_s1_agent:cp_endofpacket
	wire          gled_s1_burst_adapter_source0_valid;                                    // gLed_s1_burst_adapter:source0_valid -> gLed_s1_agent:cp_valid
	wire  [112:0] gled_s1_burst_adapter_source0_data;                                     // gLed_s1_burst_adapter:source0_data -> gLed_s1_agent:cp_data
	wire          gled_s1_burst_adapter_source0_ready;                                    // gLed_s1_agent:cp_ready -> gLed_s1_burst_adapter:source0_ready
	wire    [7:0] gled_s1_burst_adapter_source0_channel;                                  // gLed_s1_burst_adapter:source0_channel -> gLed_s1_agent:cp_channel
	wire          gled_s1_burst_adapter_source0_startofpacket;                            // gLed_s1_burst_adapter:source0_startofpacket -> gLed_s1_agent:cp_startofpacket
	wire          gled_s1_burst_adapter_source0_endofpacket;                              // gLed_s1_burst_adapter:source0_endofpacket -> gLed_s1_agent:cp_endofpacket
	...
	wire          router_005_src_valid;                                                   // router_005:src_valid -> rLed_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_005_src_data;                                                    // router_005:src_data -> rLed_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                   // rLed_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [7:0] router_005_src_channel;                                                 // router_005:src_channel -> rLed_s1_rsp_width_adapter:in_channel
	wire          router_005_src_startofpacket;                                           // router_005:src_startofpacket -> rLed_s1_rsp_width_adapter:in_startofpacket
	wire          router_005_src_endofpacket;                                             // router_005:src_endofpacket -> rLed_s1_rsp_width_adapter:in_endofpacket
	wire          rled_s1_rsp_width_adapter_src_valid;                                    // rLed_s1_rsp_width_adapter:out_valid -> rsp_demux_004:sink_valid
	wire  [148:0] rled_s1_rsp_width_adapter_src_data;                                     // rLed_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          rled_s1_rsp_width_adapter_src_ready;                                    // rsp_demux_004:sink_ready -> rLed_s1_rsp_width_adapter:out_ready
	wire    [7:0] rled_s1_rsp_width_adapter_src_channel;                                  // rLed_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	wire          rled_s1_rsp_width_adapter_src_startofpacket;                            // rLed_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_004:sink_startofpacket
	wire          rled_s1_rsp_width_adapter_src_endofpacket;                              // rLed_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_004:sink_endofpacket
	wire          router_006_src_valid;                                                   // router_006:src_valid -> gLed_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_006_src_data;                                                    // router_006:src_data -> gLed_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                   // gLed_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [7:0] router_006_src_channel;                                                 // router_006:src_channel -> gLed_s1_rsp_width_adapter:in_channel
	wire          router_006_src_startofpacket;                                           // router_006:src_startofpacket -> gLed_s1_rsp_width_adapter:in_startofpacket
	wire          router_006_src_endofpacket;                                             // router_006:src_endofpacket -> gLed_s1_rsp_width_adapter:in_endofpacket
	wire          gled_s1_rsp_width_adapter_src_valid;                                    // gLed_s1_rsp_width_adapter:out_valid -> rsp_demux_005:sink_valid
	wire  [148:0] gled_s1_rsp_width_adapter_src_data;                                     // gLed_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	wire          gled_s1_rsp_width_adapter_src_ready;                                    // rsp_demux_005:sink_ready -> gLed_s1_rsp_width_adapter:out_ready
	wire    [7:0] gled_s1_rsp_width_adapter_src_channel;                                  // gLed_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	wire          gled_s1_rsp_width_adapter_src_startofpacket;                            // gLed_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_005:sink_startofpacket
	wire          gled_s1_rsp_width_adapter_src_endofpacket;                              // gLed_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_005:sink_endofpacket
	wire          router_007_src_valid;                                                   // router_007:src_valid -> button_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_007_src_data;                                                    // router_007:src_data -> button_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                   // button_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire    [7:0] router_007_src_channel;                                                 // router_007:src_channel -> button_s1_rsp_width_adapter:in_channel
	wire          router_007_src_startofpacket;                                           // router_007:src_startofpacket -> button_s1_rsp_width_adapter:in_startofpacket
	wire          router_007_src_endofpacket;                                             // router_007:src_endofpacket -> button_s1_rsp_width_adapter:in_endofpacket
	wire          button_s1_rsp_width_adapter_src_valid;                                  // button_s1_rsp_width_adapter:out_valid -> rsp_demux_006:sink_valid
	wire  [148:0] button_s1_rsp_width_adapter_src_data;                                   // button_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	wire          button_s1_rsp_width_adapter_src_ready;                                  // rsp_demux_006:sink_ready -> button_s1_rsp_width_adapter:out_ready
	wire    [7:0] button_s1_rsp_width_adapter_src_channel;                                // button_s1_rsp_width_adapter:out_channel -> rsp_demux_006:sink_channel
	wire          button_s1_rsp_width_adapter_src_startofpacket;                          // button_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_006:sink_startofpacket
	wire          button_s1_rsp_width_adapter_src_endofpacket;                            // button_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_006:sink_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                  // cmd_mux_004:src_valid -> rLed_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_004_src_data;                                                   // cmd_mux_004:src_data -> rLed_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                  // rLed_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [7:0] cmd_mux_004_src_channel;                                                // cmd_mux_004:src_channel -> rLed_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_004_src_startofpacket;                                          // cmd_mux_004:src_startofpacket -> rLed_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                            // cmd_mux_004:src_endofpacket -> rLed_s1_cmd_width_adapter:in_endofpacket
	wire          rled_s1_cmd_width_adapter_src_valid;                                    // rLed_s1_cmd_width_adapter:out_valid -> rLed_s1_burst_adapter:sink0_valid
	wire  [112:0] rled_s1_cmd_width_adapter_src_data;                                     // rLed_s1_cmd_width_adapter:out_data -> rLed_s1_burst_adapter:sink0_data
	wire          rled_s1_cmd_width_adapter_src_ready;                                    // rLed_s1_burst_adapter:sink0_ready -> rLed_s1_cmd_width_adapter:out_ready
	wire    [7:0] rled_s1_cmd_width_adapter_src_channel;                                  // rLed_s1_cmd_width_adapter:out_channel -> rLed_s1_burst_adapter:sink0_channel
	wire          rled_s1_cmd_width_adapter_src_startofpacket;                            // rLed_s1_cmd_width_adapter:out_startofpacket -> rLed_s1_burst_adapter:sink0_startofpacket
	wire          rled_s1_cmd_width_adapter_src_endofpacket;                              // rLed_s1_cmd_width_adapter:out_endofpacket -> rLed_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_005_src_valid;                                                  // cmd_mux_005:src_valid -> gLed_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_005_src_data;                                                   // cmd_mux_005:src_data -> gLed_s1_cmd_width_adapter:in_data
	wire          cmd_mux_005_src_ready;                                                  // gLed_s1_cmd_width_adapter:in_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                // cmd_mux_005:src_channel -> gLed_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_005_src_startofpacket;                                          // cmd_mux_005:src_startofpacket -> gLed_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                            // cmd_mux_005:src_endofpacket -> gLed_s1_cmd_width_adapter:in_endofpacket
	wire          gled_s1_cmd_width_adapter_src_valid;                                    // gLed_s1_cmd_width_adapter:out_valid -> gLed_s1_burst_adapter:sink0_valid
	wire  [112:0] gled_s1_cmd_width_adapter_src_data;                                     // gLed_s1_cmd_width_adapter:out_data -> gLed_s1_burst_adapter:sink0_data
	wire          gled_s1_cmd_width_adapter_src_ready;                                    // gLed_s1_burst_adapter:sink0_ready -> gLed_s1_cmd_width_adapter:out_ready
	wire    [7:0] gled_s1_cmd_width_adapter_src_channel;                                  // gLed_s1_cmd_width_adapter:out_channel -> gLed_s1_burst_adapter:sink0_channel
	wire          gled_s1_cmd_width_adapter_src_startofpacket;                            // gLed_s1_cmd_width_adapter:out_startofpacket -> gLed_s1_burst_adapter:sink0_startofpacket
	wire          gled_s1_cmd_width_adapter_src_endofpacket;                              // gLed_s1_cmd_width_adapter:out_endofpacket -> gLed_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_006_src_valid;                                                  // cmd_mux_006:src_valid -> button_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_006_src_data;                                                   // cmd_mux_006:src_data -> button_s1_cmd_width_adapter:in_data
	wire          cmd_mux_006_src_ready;                                                  // button_s1_cmd_width_adapter:in_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                // cmd_mux_006:src_channel -> button_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_006_src_startofpacket;                                          // cmd_mux_006:src_startofpacket -> button_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                            // cmd_mux_006:src_endofpacket -> button_s1_cmd_width_adapter:in_endofpacket
	...
	wire          rled_s1_agent_rdata_fifo_src_valid;                                     // rLed_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] rled_s1_agent_rdata_fifo_src_data;                                      // rLed_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          rled_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_004:in_0_ready -> rLed_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                      // avalon_st_adapter_004:out_0_valid -> rLed_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                       // avalon_st_adapter_004:out_0_data -> rLed_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                      // rLed_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                      // avalon_st_adapter_004:out_0_error -> rLed_s1_agent:rdata_fifo_sink_error
	wire          gled_s1_agent_rdata_fifo_src_valid;                                     // gLed_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] gled_s1_agent_rdata_fifo_src_data;                                      // gLed_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          gled_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_005:in_0_ready -> gLed_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                      // avalon_st_adapter_005:out_0_valid -> gLed_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                       // avalon_st_adapter_005:out_0_data -> gLed_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                      // gLed_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                      // avalon_st_adapter_005:out_0_error -> gLed_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (pcie_hard_ip_0_pcie_core_clk_clk),         //                      clk.clk
		.reset                  (inport_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (rled_s1_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (rled_s1_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (rled_s1_agent_m0_read),                    //                         .read
		.uav_write              (rled_s1_agent_m0_write),                   //                         .write
		.uav_waitrequest        (rled_s1_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (rled_s1_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (rled_s1_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (rled_s1_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (rled_s1_agent_m0_writedata),               //                         .writedata
		.uav_lock               (rled_s1_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (rled_s1_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (rLed_s1_address),                          //      avalon_anti_slave_0.address
		.av_write               (rLed_s1_write),                            //                         .write
		.av_readdata            (rLed_s1_readdata),                         //                         .readdata
		.av_writedata           (rLed_s1_writedata),                        //                         .writedata
		.av_chipselect          (rLed_s1_chipselect),                       //                         .chipselect
		.av_read                (),                                         //              (terminated)
		.av_begintransfer       (),                                         //              (terminated)
		.av_beginbursttransfer  (),                                         //              (terminated)
		.av_burstcount          (),                                         //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (pcie_hard_ip_0_pcie_core_clk_clk),         //                      clk.clk
		.reset                  (inport_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (gled_s1_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (gled_s1_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (gled_s1_agent_m0_read),                    //                         .read
		.uav_write              (gled_s1_agent_m0_write),                   //                         .write
		.uav_waitrequest        (gled_s1_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (gled_s1_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (gled_s1_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (gled_s1_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (gled_s1_agent_m0_writedata),               //                         .writedata
		.uav_lock               (gled_s1_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (gled_s1_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (gLed_s1_address),                          //      avalon_anti_slave_0.address
		.av_write               (gLed_s1_write),                            //                         .write
		.av_readdata            (gLed_s1_readdata),                         //                         .readdata
		.av_writedata           (gLed_s1_writedata),                        //                         .writedata
		.av_chipselect          (gLed_s1_chipselect),                       //                         .chipselect
		.av_read                (),                                         //              (terminated)
		.av_begintransfer       (),                                         //              (terminated)
		.av_beginbursttransfer  (),                                         //              (terminated)
		.av_burstcount          (),                                         //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (pcie_hard_ip_0_pcie_core_clk_clk),            //             clk.clk
		.reset                   (inport_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (rled_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (rled_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (rled_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (rled_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (rled_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (rled_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (rled_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (rled_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (rled_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (rled_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (rled_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (rled_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (rled_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (rled_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (rled_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (rled_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (rled_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (rled_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (rled_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (rled_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (rled_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (rled_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (rled_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (rled_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (rled_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (rled_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (rled_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (rled_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (rled_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (rled_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (rled_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (rled_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),           //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),            //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),           //                .error
		.rdata_fifo_src_ready    (rled_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (rled_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (rled_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                       //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                         //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) rled_s1_agent_rsp_fifo (
		.clk               (pcie_hard_ip_0_pcie_core_clk_clk),         //       clk.clk
		.reset             (inport_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (rled_s1_agent_rf_source_data),             //        in.data
		.in_valid          (rled_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (rled_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (rled_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (rled_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (rled_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (rled_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (rled_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (rled_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (rled_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                    // (terminated)
		.csr_read          (1'b0),                                     // (terminated)
		.csr_write         (1'b0),                                     // (terminated)
		.csr_readdata      (),                                         // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (pcie_hard_ip_0_pcie_core_clk_clk),            //             clk.clk
		.reset                   (inport_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (gled_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (gled_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (gled_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (gled_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (gled_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (gled_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (gled_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (gled_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (gled_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (gled_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (gled_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (gled_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (gled_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (gled_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (gled_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (gled_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (gled_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (gled_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (gled_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (gled_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (gled_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (gled_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (gled_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (gled_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (gled_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (gled_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (gled_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (gled_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (gled_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (gled_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (gled_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (gled_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),           //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),            //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),           //                .error
		.rdata_fifo_src_ready    (gled_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (gled_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (gled_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                       //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                         //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) gled_s1_agent_rsp_fifo (
		.clk               (pcie_hard_ip_0_pcie_core_clk_clk),         //       clk.clk
		.reset             (inport_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (gled_s1_agent_rf_source_data),             //        in.data
		.in_valid          (gled_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (gled_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (gled_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (gled_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (gled_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (gled_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (gled_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (gled_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (gled_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                    // (terminated)
		.csr_read          (1'b0),                                     // (terminated)
		.csr_write         (1'b0),                                     // (terminated)
		.csr_readdata      (),                                         // (terminated)
	...
	pcihellocore_mm_interconnect_0_router_001 router_005 (
		.sink_ready         (rled_s1_agent_rp_ready),                   //      sink.ready
		.sink_valid         (rled_s1_agent_rp_valid),                   //          .valid
		.sink_data          (rled_s1_agent_rp_data),                    //          .data
		.sink_startofpacket (rled_s1_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (rled_s1_agent_rp_endofpacket),             //          .endofpacket
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),         //       clk.clk
		.reset              (inport_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcihellocore_mm_interconnect_0_router_001 router_006 (
		.sink_ready         (gled_s1_agent_rp_ready),                   //      sink.ready
		.sink_valid         (gled_s1_agent_rp_valid),                   //          .valid
		.sink_data          (gled_s1_agent_rp_data),                    //          .data
		.sink_startofpacket (gled_s1_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (gled_s1_agent_rp_endofpacket),             //          .endofpacket
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),         //       clk.clk
		.reset              (inport_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (1),
		.ADAPTER_VERSION           ("13.1")
	) rled_s1_burst_adapter (
		.clk                   (pcie_hard_ip_0_pcie_core_clk_clk),            //       cr0.clk
		.reset                 (inport_reset_reset_bridge_in_reset_reset),    // cr0_reset.reset
		.sink0_valid           (rled_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (rled_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (rled_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (rled_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (rled_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (rled_s1_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (rled_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (rled_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (rled_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (rled_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (rled_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (rled_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (1),
		.ADAPTER_VERSION           ("13.1")
	) gled_s1_burst_adapter (
		.clk                   (pcie_hard_ip_0_pcie_core_clk_clk),            //       cr0.clk
		.reset                 (inport_reset_reset_bridge_in_reset_reset),    // cr0_reset.reset
		.sink0_valid           (gled_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (gled_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (gled_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (gled_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (gled_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (gled_s1_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (gled_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (gled_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (gled_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (gled_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (gled_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (gled_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	pcihellocore_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),            //       clk.clk
		.reset              (inport_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.sink_ready         (rled_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (rled_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (rled_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (rled_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (rled_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (rled_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	pcihellocore_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),            //       clk.clk
		.reset              (inport_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.sink_ready         (gled_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (gled_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (gled_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (gled_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (gled_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (gled_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (rled_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (rled_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (rled_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (rled_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (rled_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (rled_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                       // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (gled_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (gled_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (gled_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (gled_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (gled_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (gled_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                       // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (rled_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (rled_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (rled_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (rled_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (rled_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (rled_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                       // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (gled_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (gled_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (gled_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (gled_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (gled_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (gled_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                       // (terminated)
	);
	...
	pcihellocore_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pcie_hard_ip_0_pcie_core_clk_clk),         // in_clk_0.clk
		.in_rst_0_reset (inport_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (rled_s1_agent_rdata_fifo_src_data),        //     in_0.data
		.in_0_valid     (rled_s1_agent_rdata_fifo_src_valid),       //         .valid
		.in_0_ready     (rled_s1_agent_rdata_fifo_src_ready),       //         .ready
	...
	pcihellocore_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pcie_hard_ip_0_pcie_core_clk_clk),         // in_clk_0.clk
		.in_rst_0_reset (inport_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (gled_s1_agent_rdata_fifo_src_data),        //     in_0.data
		.in_0_valid     (gled_s1_agent_rdata_fifo_src_valid),       //         .valid
		.in_0_ready     (gled_s1_agent_rdata_fifo_src_ready),       //         .ready
